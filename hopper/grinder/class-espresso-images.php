...
This is based of the Regenerate Thumbnails Plugin by Viper007Bond
...
class EspressoImages {
	...
	function add_admin_menu() {
		$this->menu_id = add_theme_page( __( 'Regen Images', 'regenerate-thumbnails' ), __( 'Regen Images', 'regenerate-thumbnails' ), 'manage_options', 'regenerate-thumbnails', array(&$this, 'regenerate_interface') );
	}
	...
	function admin_enqueues( $hook_suffix ) {
		...
		if ( wp_script_is( 'jquery-ui-widget', 'registered' ) )
			wp_enqueue_script( 'jquery-ui-progressbar', PARENT_URL.'/hopper/js/jquery.ui.progressbar.min.js', array( 'jquery-ui-core', 'jquery-ui-widget' ), '1.8.6' );
		else
			wp_enqueue_script( 'jquery-ui-progressbar', PARENT_URL.'/hopper/js/jquery.ui.progressbar.min.1.7.2.js', array( 'jquery-ui-core' ), '1.7.2' );

		wp_enqueue_style( 'jquery-ui-regenthumbs', PARENT_URL.'/hopper/css/redmond/jquery-ui-1.7.2.custom.css', array(), '1.7.2' );
	}
	...
	function add_media_row_action( $actions, $post ) {
		...
		$url = wp_nonce_url( admin_url( 'themes.php?page=regenerate-thumbnails&goback=1&ids=' . $post->ID ), 'regenerate-thumbnails' );
...
<div class="wrap regenthumbs">
	<h2><?php _e('Regenerate Images', 'regenerate-thumbnails'); ?></h2>
...
<?php wp_nonce_field('regenerate-thumbnails') ?>
	...
	<p><input type="submit" class="button hide-if-no-js" name="regenerate-thumbnails" id="regenerate-thumbnails" value="<?php _e( 'Regenerate All Custom Image Sizes', 'regenerate-thumbnails' ) ?>" /></p>
...
add_action( 'init', 'EspressoImagesInit' );
function EspressoImagesInit() {
	global $EspressoImages;
	$EspressoImages = new EspressoImages();
}
